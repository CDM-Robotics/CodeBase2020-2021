...
import team6072.robot2020.utility.movement.pathfinder.Bezier.BezierPoint;
...
//				m_p0.m_x, m_p0.m_y, m_p1.m_x, m_p1.m_y, m_p2.m_x, m_p2.m_y, m_p3.m_x, m_p3.m_y, m_p4.m_x, m_p4.m_y, m_p5.m_x, m_p5.m_y));
    ...
    public void computePathPoints(PathPoint[] points, int first, int sample_count, double maxVelocity) 
    {
        double distance = 0;
